...
typedef struct ListData Data;

struct ListData {

	int refCount;		/* Count how many pointers are pointed to the node */
	int remove;		/* To check if the node has been removed or not */
	void* data;		/* Store opaque data */
	Data *nextData;		/* Link to next data in list */

};

typedef struct SortedList* SortedListPtr;
typedef struct SortedList SortedListNode;

struct SortedList 
{
	CompareFuncT compare;	/* Store the pointer to the compare function */
	DestructFuncT destruct;	/* Store the pointer to the destruct function */
	Data* headList;		/* Store the data at the head of the sorted list */
};
...
{
	Data* headData;		/* Store the data at the head of the sorted list */
	SortedListPtr list;	/* Store the SortedListPtr object */
};
typedef struct SortedListIterator SortedListIterate;
